    ...
    <body>
        ...
        <div class="wrapper-page">
            <div class="ex-page-content text-center">
                ...
                <h2>Who0ps! No Permission For U</h2><br>
                <p class="text-muted">U Cannot login here</p>
                <p class="text-muted">Use the navigation above or the button below to get back and track.</p>
                <br>
                <a class="btn btn-default waves-effect waves-light" href="./login.php"> Return Home</a>
