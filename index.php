<?php include_once ("../Webshop/includes/header.php") ?>
...
?>
    ...
    <div class="banner container">
      ...
      <div class="main-banner owl-carousel">
        <div class="item"><a href="#"><img src="images/gamerzbanner.png" alt="Main Banner" class="img-responsive" /></a></div>
        <div class="item"><a href="#"><img src=""  alt="Main Banner" class="img-responsive" /></a></div>
      </div>
    </div>
    <!-- =====  BANNER END  ===== -->
    <!-- =====  CONTAINER START  ===== -->
        ...
        <div class="col-sm-12 mt_30">
          ...
          <div id="product-tab" class="mt_10">
            <div class="heading-part mb_10 ">
              <h2 class="main_title">Hot Products</h2>
            </div>
                  ...
                  <div class="product-grid">
                    <div class="item">
                      <div class="product-thumb">
                        <div class="image product-imageblock"> <a href="product_detail_page.html"> <img data-name="product_image" src="images/product/0.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive"> <img src="images/product/product9-1.jpg" alt="iPod Classic" title="iPod Classic" class="img-responsive"> </a>
                         <!-- icons on product -->
        ...
        <div class="cms_banner">
          <div class="col-xs-12 mt_60">
            <div id="subbanner4" class="sub-hover">
              <div class="sub-img"><a href="#"><img src="images/gamingbanner.png" alt="Sub Banner5" class="img-responsive"></a></div>
            </div>
          </div>
        </div>
